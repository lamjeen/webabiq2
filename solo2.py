...
- WINDOW_WIDTH/HEIGHT: Main window dimensions
- SPLASH_DURATION: How long splash screen shows
...
"""
Utility Functions:
- validate_credentials: Checks username/password
- validate_amount: Ensures amount is valid number
...
def validate_amount(amount_str):
    """Ensures amount input is a valid number"""
    try:
...
"""
AccountData Class:
Manages all transaction data and calculations including:
- Adding transactions
- Calculating totals
...
class AccountData:
    ...
    def total_saving(self):
        """Calculates net savings (income - paid)"""
        return self.income - self.paid
    
    @property
    def monthly_range(self):
        """Gets current month's date range"""
        today = date.today()
    ...
    def monthly_total(self):
        """Calculates net total for current month"""
...
"""
ToggleButton Class:
Custom radio button widget with toggle functionality
...
class ToggleButton(tk.Radiobutton):
    ...
    def update_state(self):
        """Updates button appearance based on selection state"""
...
class InputScreen(tk.Frame):
    ...
    def setup_ui(self):
        """Creates transaction input form"""
    ...
    def save_transaction(self):
        """Validates and saves new transaction"""
    ...
    def return_to_account(self):
        """Returns to main account screen"""
        self.pack_forget()
        if self.on_back:
            self.on_back()
...
class AccountScreen(tk.Frame):
    ...
    def on_canvas_configure(self, event):
        """Updates canvas width when window resizes"""
    ...
    def show_entry_dialog(self):
        """Shows transaction input screen"""
        self.pack_forget()
    ...
    def on_input_complete(self):
        """Updates display after new transaction"""
        self.update_displays()
        self.pack(fill="both", expand=True)
    
    def on_input_back(self):
        """Returns from input screen"""
        self.pack(fill="both", expand=True)
    
    def update_displays(self):
        """Updates all displays with current data"""
...
def main():
    ...
    def show_login():
        """Transitions from splash to login screen"""
        splash.destroy()
    ...
    def show_account(login_screen):
        """Transitions from login to account screen"""
